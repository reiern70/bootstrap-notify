...
(function(factory) {
  ...
  var Notify, defaults, isDuplicateNotification;
  ...
  isDuplicateNotification = function(notification) {
    var isDupe;
    isDupe = false;
    $('[data-notify="container"]').each(function(i, el) {
      var $el, isSameMsg, isSameTitle, isSameType, message, title;
      $el = $(el);
    ...
    init: function() {
      ...
      this.notify = {
        ...
        update: function(command, update) {
          var $icon, cmd, commands, newDelay, posX;
          commands = {};
          ...
          posX = this.$ele.outerHeight() + parseInt(self.settings.spacing) + parseInt(self.settings.offset.y);
